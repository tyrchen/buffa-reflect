...
impl Builder {
    ...
    pub fn generate_view_reflection(mut self, enabled: bool) -> Self {
        self.generate_view_reflection = enabled;
        self
    }
    ...
    pub fn compile(self) -> Result<(), Error> {
        ...
        if self.generate_view_reflection {
...
fn emit_view_reflection_file(
    ...
    out.push_str("// @generated by buffa-reflect-build for view reflection. DO NOT EDIT.\n");
